...
data class NilaiFinalKeterampilanResponse(
    ...
    @field:SerializedName("nilaifinalketerampilan")
    val nilaifinalketerampilan: List<ResultsNilaiFinalKeterampilan>
)

data class ResultsNilaiFinalKeterampilan(
